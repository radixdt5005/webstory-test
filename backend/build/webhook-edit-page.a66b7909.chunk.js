...
const EventInput = ({ isDraftAndPublish }) => {
  ...
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Field.FieldLabel, null, formatMessage({
    ...
    return /* @__PURE__ */ react.createElement("td", { key: header }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage(header)));
    ...
    dist.FieldArray,
    {
      ...
      render: ({ push, remove }) => {
        ...
        return /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4 }, (_a = values.headers) == null ? void 0 : _a.map((header, i) => {
          ...
          return /* @__PURE__ */ react.createElement(react.Fragment, { key: i }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6 }, /* @__PURE__ */ react.createElement(
            dist.Field,
            {
...
const Status = ({ isPending, statusCode }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  if (isPending) {
    return /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2, style: { alignItems: "center" } }, /* @__PURE__ */ react.createElement(Icon, { as: Loader["default"] }), /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({ id: "Settings.webhooks.trigger.pending", defaultMessage: "pending" })));
  }
  if (statusCode >= 200 && statusCode < 300) {
    return /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2, style: { alignItems: "center" } }, /* @__PURE__ */ react.createElement(Icon, { as: Check/* default */.Z, color: "success700" }), /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({ id: "Settings.webhooks.trigger.success", defaultMessage: "success" })));
  }
  if (statusCode >= 300) {
    return /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2, style: { alignItems: "center" } }, /* @__PURE__ */ react.createElement(Icon, { as: Cross["default"], color: "danger700" }), /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({ id: "Settings.error", defaultMessage: "error" }), " ", statusCode));
  }
  return null;
};
Status.propTypes = {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit: handleSubmit2, errors }) => /* @__PURE__ */ react.createElement(build.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(
      Layout.HeaderLayout,
      {
        ...
        ), /* @__PURE__ */ react.createElement(Button.Button, { startIcon: /* @__PURE__ */ react.createElement(Check/* default */.Z, null), onClick: handleSubmit2, type: "submit", size: "L" }, formatMessage({
          id: "global.save",
          defaultMessage: "Save"
        }))),
