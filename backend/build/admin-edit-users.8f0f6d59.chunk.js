...
const MagicLinkWrapper = ({ children, target }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    ...
    {
      endAction: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_3__.CopyToClipboard, { onCopy: handleCopy, text: target }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_IconButton__WEBPACK_IMPORTED_MODULE_1__.IconButton, { label: copyLabel, noBorder: true, icon: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_icons_Duplicate__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, null) })),
      title: target,
      titleEllipsis: true,
      subtitle: children,
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(78384);
/* harmony import */ var _strapi_icons_Loader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(86647);
/* harmony import */ var _core_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(23998);
var __async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
...
`;
const Loader = () => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(LoadingWrapper, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_icons_Loader__WEBPACK_IMPORTED_MODULE_4__["default"], null));
const fetchData = () => __async(void 0, null, function* () {
  const { data } = yield _core_utils__WEBPACK_IMPORTED_MODULE_2__/* .axiosInstance.get */ .be.get("/admin/roles");
  return data.data;
});
