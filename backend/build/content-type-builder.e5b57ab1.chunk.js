...
const AttributeList = ({ attributes }) => /* @__PURE__ */ react.createElement(KeyboardNavigable.KeyboardNavigable, { tagName: "button" }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 8 }, attributes.map((attributeRow, index) => {
  return /* @__PURE__ */ react.createElement(Grid.Grid, { key: index, gap: 0 }, attributeRow.map((attribute, index2) => {
...
const EmptyAttributes = () => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Box.Box, { position: "relative" }, /* @__PURE__ */ react.createElement(EmptyCardGrid, null), /* @__PURE__ */ react.createElement(Box.Box, { position: "absolute", top: 6, width: "100%" }, /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "center", justifyContent: "center", direction: "column" }, /* @__PURE__ */ react.createElement(Icon.Icon, { as: EmptyDocuments["default"], color: "", width: "160px", height: "88px" }), /* @__PURE__ */ react.createElement(Box.Box, { paddingTop: 6, paddingBottom: 4 }, /* @__PURE__ */ react.createElement(Box.Box, { textAlign: "center" }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "p", textColor: "neutral600" }, formatMessage({
  ...
  }))))), /* @__PURE__ */ react.createElement(LinkButton.LinkButton, { to: "/marketplace", variant: "secondary", startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null) }, formatMessage({
...
const DraftAndPublishToggle = ({
  ...
  ), showWarning && /* @__PURE__ */ react.createElement(Dialog.Dialog, { onClose: handleToggle, title: "Confirmation", isOpen: showWarning }, /* @__PURE__ */ react.createElement(Dialog.DialogBody, { icon: /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], null) }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 2 }, /* @__PURE__ */ react.createElement(Flex.Flex, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(TypographyTextAlign, { id: "confirm-description" }, formatMessage({
...
const ComponentIconPicker = ({ error, intlLabel, name, onChange, value }) => {
  ...
  )) : /* @__PURE__ */ react.createElement(IconButton.IconButton, { onClick: toggleSearch, "aria-label": "Edit", icon: /* @__PURE__ */ react.createElement(Search["default"], null), noBorder: true })), /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Box.Box, { padding: 1, background: "neutral100", borderColor: error ? "danger600" : "", hasRadius: true }, /* @__PURE__ */ react.createElement(
...
var v = Object.prototype.hasOwnProperty, OneWay_d = Object.prototype.propertyIsEnumerable;
var a = (l, e, t) => e in l ? OneWay_r(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, OneWay_i = (l, e) => {
  for (var t in e || (e = {}))
    v.call(e, t) && a(l, t, e[t]);
  if (OneWay_n)
    for (var t of OneWay_n(e))
      OneWay_d.call(e, t) && a(l, t, e[t]);
  return l;
};
...
const ContentTypeBuilderNav = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    ), section.customLink && /* @__PURE__ */ react.createElement(Box.Box, { paddingLeft: 7 }, /* @__PURE__ */ react.createElement(TextButton.TextButton, { onClick: section.customLink.onClick, startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null), marginTop: 2 }, formatMessage({
