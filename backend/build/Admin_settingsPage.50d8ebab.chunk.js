...
const ApplicationInfosPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Application" }), /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      ...
      primaryAction: /* @__PURE__ */ react.createElement(Button.Button, { onClick: handleSubmit, startIcon: /* @__PURE__ */ react.createElement(Check/* default */.Z, null) }, formatMessage({ id: "global.save", defaultMessage: "Save" }))
    }
...
const ConditionsButton = ({ onClick, className, hasConditions, variant }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Wrapper, { hasConditions, className }, /* @__PURE__ */ react.createElement(Button.Button, { variant, startIcon: /* @__PURE__ */ react.createElement(Cog/* default */.Z, null), onClick }, formatMessage({
    id: "global.settings",
    defaultMessage: "Settings"
  })));
};
...
const ConditionsModal = ({ actions, headerBreadCrumbs, isFormDisabled, onClosed, onToggle }) => {
  ...
  ))))), /* @__PURE__ */ react.createElement(Box.Box, { padding: 8 }, /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 6 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "beta", as: "h2" }, formatMessage({
...
const CarretIcon = (0,styled_components_browser_cjs["default"])(CarretDown["default"])`
  display: none;
  width: ${10 / 16}rem;
...
const UpgradePlanModal = ({ onClose, isOpen }) => {
  ...
  return /* @__PURE__ */ react.createElement(Portal.Portal, null, /* @__PURE__ */ react.createElement(UpgradeWrapper, { onClick: onClose }, /* @__PURE__ */ react.createElement(FocusTrap.FocusTrap, { onEscape: onClose }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(CloseButtonContainer, null, /* @__PURE__ */ react.createElement(IconButton.IconButton, { onClick: onClose, "aria-label": "Close", icon: /* @__PURE__ */ react.createElement(Cross["default"], null) })),
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      primaryAction: /* @__PURE__ */ react.createElement(Button.Button, { onClick: handleToggleModalForCreatingRole, startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null), size: "S" }, formatMessage({
    ...
    Table.Table,
    {
      colCount,
      rowCount,
      footer: /* @__PURE__ */ react.createElement(Table.TFooter, { onClick: handleToggleModalForCreatingRole, icon: /* @__PURE__ */ react.createElement(Plus["default"], null) }, formatMessage({
        id: "Settings.roles.list.button.add",
        defaultMessage: "Add new role"
      }))
    },
    ...
    /* @__PURE__ */ react.createElement(Table.Tbody, null, sortedRoles == null ? void 0 : sortedRoles.map((role) => /* @__PURE__ */ react.createElement(
      RoleRow/* default */.Z,
      {
        key: role.id,
        id: role.id,
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      primaryAction: canCreate ? /* @__PURE__ */ react.createElement(Button.Button, { onClick: handleNewRoleClick, startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null), size: "S" }, formatMessage({
        id: "Settings.roles.list.button.add",
        defaultMessage: "Add new role"
      })) : null,
      title,
    ...
    Table.Table,
    {
      colCount,
      rowCount,
      footer: canCreate ? /* @__PURE__ */ react.createElement(Table.TFooter, { onClick: handleNewRoleClick, icon: /* @__PURE__ */ react.createElement(Plus["default"], null) }, formatMessage({
        id: "Settings.roles.list.button.add",
        defaultMessage: "Add new role"
      })) : null
    },
