...
var EditAssetDialog = __webpack_require__(36475);
...
const Header = ({
  ...
  return /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      ...
      primaryAction: canCreate && /* @__PURE__ */ react.createElement(Stack.Stack, { horizontal: true, spacing: 2 }, /* @__PURE__ */ react.createElement(Button.Button, { startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null), variant: "secondary", onClick: onToggleEditFolderDialog }, formatMessage({
        id: (0,utils/* getTrad */.OB)("header.actions.add-folder"),
        defaultMessage: "Add new folder"
      })), /* @__PURE__ */ react.createElement(Button.Button, { startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null), onClick: onToggleUploadAssetDialog }, formatMessage({
...
const EmptyOrNoPermissions = ({ canCreate, isFiltering, canRead, onActionClick }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    EmptyAssets/* EmptyAssets */.i,
    {
      ...
      action: canCreate && !isFiltering && /* @__PURE__ */ react.createElement(Button.Button, { variant: "secondary", startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null), onClick: onActionClick }, formatMessage({
        id: (0,utils/* getTrad */.OB)("header.actions.add-assets"),
        defaultMessage: "Add new assets"
      })),
